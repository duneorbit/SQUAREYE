		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-5 col-md-5">
					<xsl:value-of select="java:org.kscb.dao.utils.Utilities.decode(//Editor[@name = 'middleEditor'])" />
				</div>
				<div class="col-sm-2 col-md-2">
	...
	<xsl:template match="/TemplateXML">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-5 col-md-5">
					<xsl:variable name="middleEditor">
						<xsl:value-of select="//Editor[@name = 'middleEditor']" />
					</xsl:variable>
					<xsl:element name="textarea">
						<xsl:attribute name="class">
            				<xsl:value-of select="'forEditor'"/>
        				...
        				<xsl:attribute name="name">
            				<xsl:value-of select="'middleEditor'"/>
        				</xsl:attribute>
        				<xsl:attribute name="cols">
            				<xsl:value-of select="'40'"/>
        				</xsl:attribute>
	...
	<xsl:template match="blank">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-5 col-md-5">
					<textarea class="forEditor" name="middleEditor" cols="40" id="middleEditor"/>
				</div>
				<div class="col-sm-2 col-md-2">
